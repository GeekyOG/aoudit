...
function ClosingStock() {
  ...
  const isAfter6PM = dayjs().hour() >= 18; // Check if current time is 6PM or later
  ...
  return (
    <div>
      {isAfter6PM ? (
        ...
        <Container className="flex items-center justify-center h-[60vh]">
          <p className="text-[1.2rem] text-red-500 text-center font-[700]">
            Closing stock is only available from 6 PM.
          </p>
        </Container>
      )}
    </div>
